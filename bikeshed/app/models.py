...
class Brand(models.Model):
    ...
    image = ResizedImageField(size=[150, 150], upload_to=app.helpers.sanitaze_image_upload_path, default="")
...
class Bike(models.Model):
    ...
    image_thumbnail = ResizedImageField(size=[262, 190], upload_to=app.helpers.sanitaze_image_upload_path, default="")
    image = ResizedImageField(size=[570, 400], upload_to=app.helpers.sanitaze_image_upload_path, blank=False)
